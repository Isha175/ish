...
public class First {
	public static void main(String[]args) throws InterruptedException {
	 ...
	 Thread.sleep(2000);
	 WebElement we=driver.findElement(By.xpath("//div[@class='kundli_form ']/child::input[@class='kundli_form_input']"));
	 we.sendKeys("Kota, Rajasthan, IN");
	 Thread.sleep(4000);
	 Actions ac=new Actions(driver);
	 WebElement dropDown = driver.findElement(By.xpath("//ul[@id='ui-id-1']//li[@class='ui-menu-item']"));
